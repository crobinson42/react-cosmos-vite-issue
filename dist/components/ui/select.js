...
const SelectLabel = React.forwardRef(({ className, ...props }, ref) => ((0, jsx_runtime_1.jsx)(SelectPrimitive.Label, { ref: ref, className: (0, cn_1.cn)("py-1.5 pl-8 pr-2 text-sm font-semibold", className), ...props })));
